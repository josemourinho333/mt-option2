...
export default function Home() {
  return (
    <>
      ...
      <section className="value-add-container flex flex-col justify-center items-center px-20">
        <div className="value-add-section flex mt-20">
          <div className="value-add-point basis-1/4 flex flex-col justify-between items-center text-center mx-5 mb-20">
            <Image 
              src={iconGrowth}
              alt="growth-icon"
              width={80}
              height={80}
            />
            <h3 className="font-semibold text-2xl my-6">Grow Your Business</h3>
          ...
          <div className="value-add-point basis-1/4 flex flex-col justify-between items-center text-center mx-5 mb-20">
            <Image 
              ...
              height={80}
            />
            <h3 className="font-semibold text-2xl my-6">Get Your Business Noticed</h3>
            <p className="text-sm">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rem consequatur ullam ex quidem totam ut repellendus adipisci, quasi sapiente doloremque expedita impedit quam consectetur nihil!</p>
          </div>
          <div className="value-add-point basis-1/4 flex flex-col justify-between items-center text-center mx-5  mb-20">
            <Image 
              ...
              height={80}
            />
            <h3 className="font-semibold text-2xl my-6">Find Perfect Solution</h3>
            <p className="text-sm">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rem consequatur ullam ex quidem totam ut repellendus adipisci, quasi sapiente doloremque expedita impedit quam consectetur nihil!</p>
          </div>
          <div className="value-add-point basis-1/4 flex flex-col justify-between items-center text-center mx-5 mb-20">
            <Image 
              ...
              height={80}
            />
            <h3 className="font-semibold text-2xl my-6">Increase Productivity</h3>
            <p className="text-sm">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rem consequatur ullam ex quidem totam ut repellendus adipisci, quasi sapiente doloremque expedita impedit quam consectetur nihil!</p>
          </div>
        </div>

        <div className="value-add-info flex my-20 gap-28">
        ...
        <div className="value-add-info flex mb-20 flex-row-reverse gap-28">
          <div className="basis-1/2">
            <Image 
                src={meetingRoom}
                alt="team-collab"
      ...
      <section className={styles.contact}>
        <div className="contact-content flex flex-col text-white items-start py-20 w-[80%] m-auto">
      ...
      <section className="flex flex-col justify-center items-center py-20 w-[80%] m-auto">
        <div className="how-we-help flex gap-28 mt-20">
          <div className="basis-1/2 flex flex-wrap">
            <div className="flex flex-col justify-between items-center basis-1/2 mb-[2rem]">
              ...
              <div className="text-lg font-bold text-[#8a6b52] mt-[1rem]">75% GROWTH</div>
            </div>
            <div className="flex flex-col justify-between items-center basis-1/2 mb-[2rem]">
              <Image src={iconDollar} width={100} height={100} alt='dollar-icon'/>
              <div className="text-lg font-bold text-[#8a6b52] mt-[1rem]">115% PROFIT</div>
            </div>
            <div className="flex flex-col justify-between items-center basis-1/2 mb-[2rem]">
              <Image src={iconLaptop} width={100} height={100} alt='laptop-icon'/>
              <div className="text-lg font-bold text-[#8a6b52] mt-[1rem]">32% SAVINGS</div>
            </div>
            <div className="flex flex-col justify-between items-center basis-1/2 mb-[2rem]">
              <Image src={iconMail} width={100} height={80} alt='mail-icon'/>
              <div className="text-lg font-bold text-[#8a6b52] mt-[1rem]">24/7 SUPPORT</div>
            </div>
          </div>
          <div className="create-a-plan basis-1/2 self-center flex flex-col">
            <h2 className="font-semibold text-2xl">We&apos;ll Help You Create a Plan</h2>
            <p className="mt-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Hic, nostrum cumque modi maiores iste illum quae ullam aspernatur itaque consectetur molestiae, recusandae dicta, quod et iusto excepturi reiciendis maxime quidem quo ex voluptatibus repellat culpa qui iure. Totam ipsa nesciunt, vero a iste eum ad suscipit incidunt aspernatur magnam nihil.</p>
          </div>
        </div>
        <div className="how-we-help flex mt-20">
